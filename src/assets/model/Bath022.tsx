...
Command: npx gltfjsx@6.2.16 public/assets/models/Bath022.glb -o src/assets/model/Bath022.tsx -r public 
*/
...
export default function Model(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF(
    "/assets/models/Bath022.glb"
  ) as GLTFResult;
  return (
    <group {...props} dispose={null}>
      <mesh
        geometry={nodes.bath02.geometry}
        material={materials["palette.002"]}
        position={[3.031, 0.107, -1.673]}
        rotation={[Math.PI / 2, 0, 0]}
      />
      <mesh
        geometry={nodes.floor02.geometry}
        material={materials.floor}
        position={[-0.855, 0.003, 4.297]}
      />
      <mesh
        geometry={nodes.wall.geometry}
        material={materials.wall}
        position={[-0.101, 0.795, 1.399]}
      ...
      <mesh
        ...
        position={[-0.486, 0.569, 1.993]}
        rotation={[Math.PI / 2, 0, 0]}
      />
      <mesh
        geometry={nodes.wall002.geometry}
        material={materials.wall}
        position={[-0.165, 0.781, 4.68]}
        rotation={[0, Math.PI / 2, 0]}
        scale={[0.095, 0.678, 1]}
      />
      <mesh
        ...
        material={materials["palette.006"]}
        position={[3.012, 0.569, 4.084]}
        rotation={[Math.PI / 2, 0, Math.PI]}
      />
      <mesh
        geometry={nodes.chair01001.geometry}
        material={materials["palette.008"]}
        position={[-0.914, 0, 1.692]}
      />
      <mesh
        geometry={nodes.Untitled007.geometry}
        material={materials["palette.006"]}
        position={[-0.376, 1.132, -2.549]}
        rotation={[Math.PI / 2, 0, 0]}
      />
      <mesh
        geometry={nodes.Cube003.geometry}
        material={materials.wall}
        position={[0.398, 0.795, -0.189]}
      ...
      <mesh
        ...
        material={materials["palette.008"]}
        position={[-0.914, 0, 3.126]}
      />
      <mesh
        geometry={nodes.chair01.geometry}
        material={materials["palette.009"]}
        position={[-0.084, 0, 1.692]}
      />
      <mesh
        geometry={nodes.bath01001.geometry}
        material={materials["palette.010"]}
        position={[6.25, 0.118, 1.95]}
        rotation={[Math.PI / 2, 0, 0]}
      />
      <mesh
        geometry={nodes.bath01.geometry}
        material={materials["palette.010"]}
        position={[6.23, 0.118, 3.656]}
        rotation={[Math.PI / 2, 0, 0]}
      />
      <mesh
        geometry={nodes.Cube004.geometry}
        material={materials.wall}
        position={[-1.261, 1.094, 3.684]}
        rotation={[Math.PI, 0, Math.PI]}
        scale={[0.095, 0.678, 1]}
      />
      <mesh
